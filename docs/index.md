...
- **💳 Multi-Account Support** - Manage expenses across different accounts
- **🔒 Secure** - Protected with authentication and authorization
- **📱 Responsive** - Works seamlessly on desktop, tablet, and mobile
- **🌙 Modern UI** - Clean interface built with NextUI components
...
!!! info "Development Status"
    Colony is currently in active development. This documentation will be updated as new features are implemented. Check the [roadmap](roadmap/) for planned features and timeline.
...
Ready to get started? Head over to our **[Getting Started](getting-started/)** guide!
