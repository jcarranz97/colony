...
# ---------------------------------------------------------------------------
# Recurrence config validators (duplicated from recurrent_expenses to avoid
# cross-domain peer import)
# ---------------------------------------------------------------------------
...
class RecurrentIncomeBase(AppBaseModel):
    """Base schema with all required recurrent income fields."""
    ...
    def validate_recurrence_config(self) -> "RecurrentIncomeBase":
...
class RecurrentIncomeCreate(RecurrentIncomeBase):
    """Schema for creating a new recurrent income."""


class RecurrentIncomeUpdate(AppBaseModel):
    """Schema for updating a recurrent income (all fields optional)."""
    ...
    @model_validator(mode="after")
    def validate_recurrence_config(self) -> "RecurrentIncomeUpdate":
...
class RecurrentIncomeResponse(BaseModel):
    """Response schema for a recurrent income."""
