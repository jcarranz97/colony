...
@router.get(
    ...
    description=(
        "Retrieve all recurrent incomes for the authenticated user "
...
async def get_recurrent_incomes(
    ...
    """Get all recurrent incomes for the authenticated user."""
...
@router.post(
    ...
    description="Create a new recurrent income for the authenticated user",
)
...
async def update_recurrent_income(
    ...
    try:
        updated = service.recurrent_income_service.update_recurrent_income(
            db, recurrent_income, data, str(current_user.id)
        )
